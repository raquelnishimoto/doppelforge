...
const errorScenarios = [
  ...
  },
  {
    ...
    input: 'GhostType',
    expectedError:
      'Alias "GhostType" points to a non-existent type: "src/models/dele.ts#GhostType". This usually means "src/models/dele.ts" is outside your configured include globs.',
  },
  {
    description: 'ambiguous short name',
    input: 'Review',
    expectedError:
      'Type "Review" is ambiguous. Use a qualified id instead:\n  "src/models/user.ts#Review"\n  "src/response.ts#Review"',
  },
];
